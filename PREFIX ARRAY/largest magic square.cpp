...
public:
    int largestMagicSquare(vector<vector<int>>& grid) {
        ...
        // check from largest grid as we have to find largest grid 
        // as soon as I get a magic square, it will be largest and I will return from there as we dont need to find sum we just need gird size 
