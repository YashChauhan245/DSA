...
// Check t has only prime factors {2,3,5,7}.
// Compute remainingFactor[i] for every prefix.
// If original number already satisfies → return it.
// Starting from the rightmost digit:
// Keep prefix fixed.
// Try increasing current digit.
// Compute remaining factor after choosing that digit.
// Check if remaining suffix can satisfy it.
// Return immediately (greedy gives smallest answer).
// If impossible with same length, construct the smallest valid number of length n+1.
