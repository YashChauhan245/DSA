...
// Algo:
// sort
// spell*minval>=success
// minportion=[1.0(success)/spell]ciel-->1st converting int value to float ffor foat division then ciel 
// binary search on  minportion

// note--> lowerbound if  val>=.....uppperbound if val>
